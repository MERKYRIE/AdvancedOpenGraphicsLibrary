...
namespace NAdvancedOpenGraphicsLibrary
{
    CVideo::CVideo()
    {
        ...
        GDebug->AAssertSimpleDirectMediaLayerHandle(FWindow = SDL_CreateWindow("Advanced Open Graphics Library" , 0 , 0 , 0 , 0 , SDL_WINDOW_OPENGL | SDL_WINDOW_FULLSCREEN_DESKTOP));
        ...
        GDebug->AAssertSimpleDirectMediaLayerCode(SDL_SetRelativeMouseMode(SDL_TRUE));
